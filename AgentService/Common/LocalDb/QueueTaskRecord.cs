        ...
        public void AddToDb(Logger logger)
        {
            using (var connection = new SQLiteConnection(DatabaseManager.ConnectionString)) {
                ...
                INSERT INTO {nameof(QueueTaskRecord)} (
                    ...
                    {nameof(QueueTaskRecord.UpdateDate)}, 
                ...
                using (var command = new SQLiteCommand(insertQuery, connection)) {
                    ...
                    command.Parameters.AddWithValue($"@{nameof(QueueTaskRecord.UpdateDate)}", UpdateDate.ToDbString());
                    ...
                    using (var reader = command.ExecuteReader()) {
                        if (reader.Read()) {
                            ...
                            return new QueueTaskRecord
                            {
                                ...
                                UpdateDate = DateTime.Parse(reader[$"{nameof(UpdateDate)}"].ToString()),
                                Type = type,
                                Status = status,
        ...
        public void UpdateInDb(Logger logger)
        {
            using (var connection = new SQLiteConnection(DatabaseManager.ConnectionString)) {
                ...
                UPDATE {nameof(QueueTaskRecord)} SET 
                    ...
                    {nameof(UpdateDate)} = @{nameof(UpdateDate)}, 
                ...
                using (var command = new SQLiteCommand(updateQuery, connection)) {
                    ...
                    command.Parameters.AddWithValue($"@{nameof(UpdateDate)}", UpdateDate.ToDbString());
