    ...
    public class JobManager {
        ...
        public void ExecuteAllJobs() {
            ...
            try {
                ...
                //log.Debug($"SchedulerType is {ObjectSettingsSingleton.Instance.ObjectSettings.SchedulerType}");
                //switch (ObjectSettingsSingleton.Instance.ObjectSettings.SchedulerType) {
                //    case SchedulerType.SingleTask: 
                //        jobs.Add(new SimpleClientJob { Name = objectSettings.Objects.FirstOrDefault().ObjectId.ToString() });
                //        break;
                //    case SchedulerType.MultiTasks: 
                //        jobs.Add(new SimpleClientJob { Name = string.Empty });
                //        break;
                //    case SchedulerType.MultiThread: 
                //        jobs.AddRange(objectSettings.Objects.Select(o => new MultiThreadClientJob { Name = o.ObjectId.ToString() }).Cast<Job>().ToList());
                //        break;
